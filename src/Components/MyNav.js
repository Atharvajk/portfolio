    ...
    <>
      <div className={`myNav ${menuOpen ? 'open' : ''}`}>
        ...
        <div className={`namediv ${menuOpen ? 'mobile-menu' : ''}`}>
          <a href="#intro" className="namelink">
            Atharva Khodke
          </a>
        </div>
        ...
        <a href="https://github.com/Atharvajk" target="_blank">
            ...
            <a
              href="https://codolio.com/profile/atharvajk"
              target="_blank"
            >
             <img src="https://codolio.com/codolio_assets/codolio.svg" alt="HTML tutorial" style={{width:20 ,height: 20}}/>
            </a>
        </div>
      </div>
    </>
