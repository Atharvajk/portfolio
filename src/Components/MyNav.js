  ...
  return (
    <>
        ...
        <div className='myNav'>
          ...
          <a href="#home" className=" namelink">Atharva Khodke</a>
          </div>
          
           <div className="linksdiv">

            <a href="#features" className="navlinks">About</a>
            <a href="#pricing"className="navlinks" >Resume</a>
            <a href="#pricing" className="navlinks">Contact</a>
           </div>
